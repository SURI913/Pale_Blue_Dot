...
public class UltimateRadialMenuEditor : Editor
{
	...
	{
		UnityEngine.Object esys = FindObjectOfType<EventSystem>();
		if( esys == null )
		{
	...
	void RequestCanvas ( GameObject child, bool screenSpaceOverlay = true )
	{
		...
		UnityEngine.Canvas[] allCanvas = UnityEngine.Object.FindObjectsOfType( typeof( UnityEngine.Canvas ) ) as UnityEngine.Canvas[];
